...
into tools/art/ (bubble.png, player.png, enemy.png, fruit.png) with index 0
...
OUT = os.path.join(os.path.dirname(__file__), "..", "bubble", "gen", "bb_gfx.z80s")
...
def main():
    ...
    w = L.append
    w(";" + "-" * 66)
    w("; bb_gfx.z80s - GENERATED by tools/bbgfx.py, do not edit by hand")
    w(";")
