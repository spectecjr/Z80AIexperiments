...
The fill is 92% of what is left, so this is now a rasteriser benchmark. 25 Hz
(240,000 T-states) needs another 45,000: the mean frame is 284,455 but the
minimum is 156,510, so the cheap orientations are already inside 25 Hz and
the expensive ones are not. Fewer, larger pieces would help everywhere;
